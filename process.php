...
if (isset($_POST['submit'])) {
    ...
    $stmt = $conn->prepare("SELECT id FROM students WHERE email =? OR matric_number=?");
    ...
    $stmt = $conn->prepare("INSERT INTO students (fullname, email, department, matric_number) VALUES (?, ?, ?, ?)");
