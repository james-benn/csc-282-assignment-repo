...
<body>
    <div class="container-fluid form-org" id="registry-form">
        <div class="container ">
            ...
            <input type="text" name="department" placeholder="Enter your department" id="password"><br>
            <label> Matric Number</label><br>
            <input type="text" name="matric_number" placeholder="Enter your matric number" id="confirmPassword"><br>
...
<a href="view.php" style="padding: 50px; font-size:large; color:black;">View Registered Students</a>
</body>
</html>